...
// Feedback component
const Feedback = ({ feedback, onSubmit, feedbackSubject, setFeedbackSubject, feedbackDescription, setFeedbackDescription }) => (
  <div>
    ...
    {feedback.length === 0 ? (
      ...
      <ul>
        {feedback.map((item, index) => (
          <li key={index}>
            <div className="feedback-item"> {/* Box for feedback */}
